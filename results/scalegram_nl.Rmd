...
We can also use the _scalegram_multiplot_ to represent the variance ratio between one dataset (here knmi stations) with the others. 
...
event_dates <- format(gpm_events[, unique(time)], "%d-%m-%Y") #test
...
g4 <- scalegram_space(gpm_events_brick) #test
g4$sg_plot
