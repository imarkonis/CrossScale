...
**data_import.R** Imports observed and modeled data for the Netherlands. Observational data are composed of two data tables, one for values and one for cell/station coordinates and then saved in _observ_raw.Rdata_. Model simulation data represent a single grid cell (coarser resolution) and thus a single data table is stored in _model_raw.Rdata_.
